$(document).ready(function() {
	...
	var url = 'https://newsapi.org/v2/everything?' + 'q=' + newsValue + "&" + 'from=2018-02-16&' + 'sortBy=popularity&' + 'apiKey=43cd043466984ada8c4d6ac84c2df3f4';
	$.ajax({
		url : url,
		    dataType : "json",
			...
			//articleUrl = console.log(json.articles[i].url);
			usNews += '<p>The URL for the article (have to copy and paste):<br>' + articleUrl + "</p>";
			//articleUrl = console.log(json.articles[0].url);
